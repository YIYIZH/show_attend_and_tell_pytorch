...
parser.add_argument('--image_dir', type=str, default='/data1/public/coco/images/train2014_resized', help='directory for resized images')
parser.add_argument('--image_dir_val', type=str, default='/data1/public/coco/images/val2014_resized', help='directory for resized images')
parser.add_argument('--caption_path', type=str, default='/data1/public/coco/annotations/captions_train2014.json', help='path for train annotation json file')
parser.add_argument('--caption_path_val', type=str, default='/data1/public/coco/annotations/captions_val2014.json', help='path for val annotation json file')
